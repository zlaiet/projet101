...
import com.example.project101.exception.FileStorageException;
import com.example.project101.exception.MyFileNotFoundException;
...
public class FileStorageService {
    ...
    public Stream<Path> loadAll() {
        try {
                return Files.walk(this.fileStorageLocation, 2).filter(path -> !path.equals(this.fileStorageLocation)).map(this.fileStorageLocation::relativize);
        } catch (IOException e) {
